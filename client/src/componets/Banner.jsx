                        ...
                        <div className='relative' key={index}>
                            ...
                            <div className='absolute top-0 left-0 w-full h-full bg-black/20'>
                                <Container className="flex flex-col justify-center gap-2 md:gap-3 h-full">
                                    ...
                                    <h2 className='text-xl md:text-5xl max-w-sm text-white  md:max-w-xl font-bold md:leading-[55px] capitalize'>{item?.title}</h2>
                                    <p className='text-xs md:text-base  text-white uppercase font-medium'>{item?.discount}</p>
                                    <p className='font-medium text-sm  text-white md:text-base'>From <span className='md:text-xl font-bold text-white md:ml-2'> ${item?.from}</span></p>
