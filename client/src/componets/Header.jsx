                            ...
                            <div className="flex flex-col gap-5 pt-5">
                                {headerNavigatin?.map((item) => (
                                    ...
                                    >
                                        ...
                                        {item?.title}
                                        <span
                                            className="absolute w-full h-[1px] bg-white/20 left-0 -bottom-1 group-hover:bg-white duration-300"
                                        />
                                ...
                                <NavLink
                                    onClick={() => setIsOpen(false)}
                                    to={"/signin"} className="hover:text-white duration-300 relative group flex items-center gap-2">
                                    <span className="w-2.5 h-2.5 rounded-full border border-white/80 inline-flex group-hover:border-white duration-300" />
                                    Signin
                                    <span
                                        className="absolute w-full h-[1px] bg-white/20 left-0 -bottom-1 group-hover:bg-white duration-300"
