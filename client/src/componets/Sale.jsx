...
const Sale = () => {
    return (
        <div className='w-full h-auto md:h-[550px] py-1 flex flex-col md:flex-row gap-10'>
            ...
            <div className="w-full md:w-1/2 h-[300px] flex flex-col justify-between  md:h-full gap-10">

                <div className='w-full h-[250px] md:justify-start md:h-[46%] border border-gray-300 rounded-md overflow-hidden relative group'>
                    <img
                        className="w-full h-full object-cover group-hover:scale-110 duration-500 ease-in-out"
                        src={saleImgTwo}
                        alt=""
                    ...
                    <div className='absolute w-full h-full top-0 left-0 bg-black/40 text-white/80 flex items-center md:items-start'>
                        <div className='flex flex-col gap-2 p-10 justify-center'>
                            <p className='text-sm md:text-lg font-medium text-white'>10% sales ongoing on phone</p>
                            <p className='text-sm md:text-xl font-semibold'>Offers on limited time</p>
                            <Link
                                className='bg-white/70 text-black  w-fit  px-8 py-3 rounded-md hover:bg-white duration-300 font-medium'
                                to="/shop"
                            >
                                Shop Now
                            </Link>
                ...
                <div className="w-full h-[250px] md:h-[46%] border border-gray-300 rounded-md overflow-hidden relative group">
                    ...
                    <div className='absolute w-full h-full top-0 left-0 bg-black/40 text-white/80 flex items-center md:items-start'>
                        <div className='flex flex-col gap-2 p-10 justify-center'>
                            ...
                            <p className='text-sm md:text-xl font-semibold'>Offers on limited time</p>
                            <Link
                                className='bg-white/70 text-black px-8 py-3 w-fit rounded-md hover:bg-white duration-300 font-medium'
                                to="/shop"
                            >
                                Shop Now
                            </Link>
